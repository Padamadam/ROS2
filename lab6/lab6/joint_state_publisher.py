...
class DobotControllerBasic(Node):

    def __init__(self):
        super().__init__('dobot_controller_basic')

        self.subscription = self.create_subscription(Marker,'/marker_publisher',self.listener_callback,10)
